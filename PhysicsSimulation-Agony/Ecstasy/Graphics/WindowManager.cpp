...
namespace Ecstasy::Graphics
{
    ...
    void WindowManager::linkInputManager(Input::InputManager* im)
    {
        if (im == nullptr)
        {
        ...
        im->setWidthHeightPointer(&width);
        linkedInputManagers.insert(im);
    }

    void WindowManager::unlinkInputManager(Input::InputManager* im)
    {
        im->setWidthHeightPointer(nullptr);
        linkedInputManagers.erase(im);
    }

    bool WindowManager::isInputManagerLinked(Input::InputManager* im) const
    {
